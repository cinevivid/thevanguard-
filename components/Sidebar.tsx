...
const WandIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 4V2m0 14v-2m-7.5 5.5 1-1m-4-11.5 1-1m10 3 1-1m-10 8 1-1m-7-1-1-1m16 0-1-1m-4 1-1-1m-3-11 1-1m-4 4 1-1m1-4L4 4m3 1 1-1m10 10 3 3m-3-11 3 3m-1-1 1-1m-4-1 1-1"/></svg>;
  ...
  return (
    <nav className="w-16 md:w-64 bg-vanguard-bg-secondary flex flex-col border-r border-vanguard-bg-tertiary">
      ...
      <div className="p-4 border-t border-vanguard-bg-tertiary text-center text-xs text-vanguard-text-secondary">
          <p className="hidden md:block">Version 5.0.0</p>
          <p className="hidden md:block">Intelligent Studio</p>
      </div>
    </nav>
  );
};
